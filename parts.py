...
class Fuel_tank:
    def __init__(self, dia = 0, lenght = 0, constr_mass  = 0, liquid_type = "LNG"):
        self._diameter  = dia
        self._radius = dia / 2
        self._lenght = lenght
        ...
        print(liquid_type," ",self._liquid_mass)
...
class Engine:
    def __init__(self, imp = 0, cunsuption = 0):
        self._imp = imp
    ...
    def CoM(self):
        return 0
class Adapter:
    def __init__(self, upper_dia =0 , lower_dia = 0, lenght = 0, mass = 0):
        self._upper_dim = upper_dia
        self._lower_dim = lower_dia
        self._lenght = lenght
        r1 = upper_dia/2
        r2 = lower_dia/2
    ...
    def CoM(self):
        return self._CoM
class Fairing:
    def __init__(self, lenght=0, dia=0, mass=0):
        self._lenght = lenght
        self._dim = dia
        self._radius = dia/2
        self._mass = mass
    ...
    def upd_masses(self):
        ...
        print('Инерция ГО: ', self._inertia)
        print('Центр тяжести ГО: ',self._static)
