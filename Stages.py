...
upper_stage.add_part_to_stage(Fuel_tank(1.7, 1.48, 105.031, liquid_type="LOX"))
upper_stage.add_part_to_stage(Fuel_tank(1.7, 1.1, 367.607,  liquid_type="LNG"))
upper_stage.add_part_to_stage(Engine(3700, 15.9))
upper_stage.add_part_to_stage(Adapter(1.7,1.7,2.1,200))

lower_stage = Stage()
lower_stage.add_part_to_stage(Fuel_tank(1.7, 8.39, 435.02, liquid_type="LOX"))
lower_stage.add_part_to_stage(Fuel_tank(1.7, 6.21, 1522.58,  liquid_type="LNG"))
lower_stage.add_part_to_stage(Engine(3300, 120))
lower_stage.add_part_to_stage(Adapter(1.7, 1.7, 2.8, 300))
